...
{	
    ...
    public function rules()
    {
        return [
            ...
            [['institute_id', 'referrer', 'role_id', 'group_id'], 'integer'],
    ...
    public function removePasswordResetToken()
    {
        $this->password_reset_token = null;
				...
				public function getUserData($email){
						$connection	=	\Yii::$app->db;
						$sql = 'select u.id, u.username,u.password_hash,u.profile_status, u.email,u.first_name,u.last_name,u.status, u.membership,u.profile_status,ug.group_name,	i.organization_name from'
														. ' user u'
														. ' left join user_group ug on ug.gid = u.group_id'
														. ' left join institute_data i on i.su_institute_id = u.institute_id'
														. ' where  u.email = "'.$email.'"';
